...
int evaluate_score(int who){
    ...
    int the_other = 3-who;
      ...
      int g;
      if(who == player)
        g = 50000*N5 + 4800*open4 + 2500*half4 + 1000*special1 + 2000*open3 + 200*half3 + 50*open2 + 10*half2;
      else 
        g = 55000*N5 + 5500*open4 + 3000*half4 + 1500*special1 + 2000*open3 + 200*half3 + 50*open2 + 10*half2; 
      return g;
    }      
};
...
Point Next_Point(State &state){
    ...
    int score = Minimax(state, 2, NEG_INF, INF, true, true);
